...
const DownloadPageEdge = () => {
  ...
  return (
    ...
    >
      ...
      >
        <StepText text="Passo 1: O programa será baixado, e você pode confirmar o Download de acordo com as imagens abaixo:" />
      </Box>
      {/* //StepImg1*/}
      <Box
        sx={{
      ...
      >
        ...
        <StepImg src="/assets/edgePasso2.png" height="400px" />
      </Box>
      {/* //StepText2*/}
      <Box
        sx={{
...
export default DownloadPageEdge;

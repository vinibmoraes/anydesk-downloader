...
const DownloadPageChrome = () => {
  ...
  return (
    ...
    >
      ...
      >
        <StepText text="Passo 1: O programa será baixado e o download pode ser exibido conforme exemplo abaixo:" />
      </Box>
      {/* //StepImg1*/}
      <Box
        sx={{
      ...
      >
        <StepImg src="/assets/chromePasso1.png" height="400px" />
      </Box>
      {/* //StepText2*/}
      <Box
        sx={{
...
export default DownloadPageChrome;
